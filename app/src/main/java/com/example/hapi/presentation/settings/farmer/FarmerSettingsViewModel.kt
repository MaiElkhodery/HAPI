...
@HiltViewModel
class FarmerSettingsViewModel @Inject constructor(
    ...
    fun onEvent(event: FarmerSettingsEvent) {
        when (event) {
            is FarmerSettingsEvent.ChangePassword -> {
                _password.value = event.password
            }

            FarmerSettingsEvent.OnClickDeleteAccount -> {
                _deleteAccount.value = true
            }

            FarmerSettingsEvent.OnClickLogout -> {
                _logout.value = true
            }
        }
    }
